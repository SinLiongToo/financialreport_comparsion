...
const I18N_DICT = {
    en: {
        ...
        guide_sec2_title: "3. Top Switcher vs. Bottom Console (Two-Way         guide_sec3_title: "4. Visual Charts & Strategic OpEx Framework Guide",
    ...
    zh: {
        ...
        modal_guide_subtitle: "工作流執行、圖表戰略解讀、10-K/10-Q/20-F/TWSE/Yuho 跨格式與 LLM 提示詞應用",
        guide_sec1_title: "1. 一步到位全自動工作流與技術架構原理",
        guide_sec1_p1: "輸入任何目標公司（如 ASML、TSMC、NVDA、FOXCONN、NXP、VSH、AMAT）或 CompaniesMarketCap 網址，選擇年數（3 至 10 年），點擊「立即執行全自動工作流」，系統將自動觸發 5 階段流水線：",
        guide_pipe_s1_title: "第 1 階段：目標智能識別與秒級本機快取爬蟲",
        guide_pipe_s1_desc: "自動識別企業註冊地（美國本土 Form 10-K/10-Q、外國發行人 Form 20-F/6-K、台灣年報等）與目標歷史年限。非同步下載歷年 PDF 原始報告至 <code>data/downloads/</code>。具備秒級本機快取（Local Cache），已下載的財報零延遲直接複用，免除重複爬取耗損。",
        ...
        guide_sec5_p: "在下方檔案瀏覽器選取解析後的 .md 檔案，點擊「複製 Markdown」，貼入 Gemini 並搭配專案內的 fininacial_prompt.md 或 sale_breakdown.md，即可在 5 秒內產出 16:9 簡報草圖與高階主管口說講稿。",進行線性插值 ($Q1 \\rightarrow Q2 \\rightarrow Q3 \\rightarrow Q4$)，確保人均產值趨勢平滑連貫。",
        guide_pipe_s4_title: "第 4 階段：戰略營運卓越 (OpEx) 與人均產值精算核心",
        guide_pipe_s4_desc: "深度融合財務損益與人力資源數據。精算<strong>人均產值三部曲</strong>（人均營收、人均毛利、人均營業利益 $/FTE）、評估<strong>營運槓桿 (Operating Leverage)</strong>、運算<strong>研發護城河強度 (R&D % of Revenue)</strong>，並識別<strong>「人力拐點 (The Pivot)」</strong>（員工總數進入高原期後，毛利率是否透過自動化持續擴張）。",
        guide_pipe_s5_title: "第 5 階段：雙視角戰略儀表板與 LLM 高階簡報生成閉環",
        guide_pipe_s5_desc: "在「單一公司深入分析」與「多公司橫向對比」雙視角下繪製 6 大 Plotly 互動圖表，支援一鍵高清放大與 CSV 匯出。解析後的 Markdown 可一鍵複製貼入 Gemini / Claude / ChatGPT 搭配專案 Prompt (<code>fininacial_prompt.md</code>)，5 秒內自動生成 16:9 董事會戰略簡報與口說講稿。",
