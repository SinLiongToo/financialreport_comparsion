...
def build_markdown_db():
    ...
    for comp in ["win-semi", "stm", "sk-hynix", "sumco", "shin-etsu", "globalwafers", "asus", "quanta", "wistron", "pegatron", "merck-kgaa", "ma-tek", "avgo", "lrcx", "adi", "txn", "swks", "agilent", "intc", "vis", "psmc", "realtek", "asml", "tsmc", "mediatek", "nvda", "qcom", "googl", "aapl", "amd", "mu", "klac", "ter", "ase", "nxp", "vsh", "msft", "amat", "meta", "amzn", "pltr", "advantest", "samsung"]:
